...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:20px 15px 15px 15px; line-height:26px; text-align:inherit; background-color:#d488cc;" height="100%" valign="top" bgcolor="#d488cc" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #932a89; font-size: 24px"><strong>R E A D &nbsp;W H A T &nbsp;Y O U &nbsp;L O V E</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 30px 30px; line-height:28px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">Hi Lisa,</span></div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">Confirmation of </span><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #932a89"><strong>order xxxxx has shipped</strong></span><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">. Click the link below to check the status of your order and to opt-in for text message updates.</span></div><div></div></div></td>
      </tr>
    </tbody>
...
<div style="font-family: inherit; text-align: inherit"><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; font-size: 16px; color: #656565">LouAnne's Bookshelf</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
    ...
    <tbody>
      <tr>
        <td style="padding:30px 0px 10px 0px; line-height:32px; text-align:inherit; background-color:#D488CC;" height="100%" valign="top" bgcolor="#D488CC" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #ffffff; font-size: 30px">“</span><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; font-size: 26px; color: #ffffff">It is what you read when you don’t have to that determines what you will be when you can’t help it.</span><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #ffffff; font-size: 30px">”</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      ...
      <a role="social-icon-link" href="https://www.instagram.com/sendgrid/" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#9D9D9D; height:21px; width:21px;">
      ...
      <a role="social-icon-link" href="https://www.pinterest.com/sendgrid/" target="_blank" alt="Pinterest" title="Pinterest" style="display:inline-block; background-color:#9D9D9D; height:21px; width:21px;">
      ...
      <a role="social-icon-link" href="https://www.linkedin.com/company/sendgrid/" target="_blank" alt="LinkedIn" title="LinkedIn" style="display:inline-block; background-color:#9D9D9D; height:21px; width:21px;">
  ...
  </table><div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#932A89; font-size:12px; line-height:22px; padding:16px 16px 5px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5"><div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-family:trebuchet ms,helvetica,sans-serif; font-size:12px; line-height:22px;">{{Sender_Name}}</p><p style="font-family:trebuchet ms,helvetica,sans-serif; font-size:12px; line-height:22px;"><span class="Unsubscribe--senderAddress">{{Sender_Address}}</span>, <span class="Unsubscribe--senderCity">{{Sender_City}}</span>, <span class="Unsubscribe--senderState">{{Sender_State}}</span> <span class="Unsubscribe--senderZip">{{Sender_Zip}}</span></p></div><p style="font-family:trebuchet ms,helvetica,sans-serif; font-size:12px; line-height:22px;"><a class="Unsubscribe--unsubscribeLink" href="{{{unsubscribe}}}" target="_blank" style="color:#9D9D9D;">Unsubscribe</a></p></div><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="63b00288-52a6-4caa-9337-9e7da43b1a6f">
      <tbody>
        <tr>
